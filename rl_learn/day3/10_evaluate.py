...
# ====================================================================
def main():
    Q = np.load(os.path.join(os.path.dirname(__file__), "trained_Q.npy"))
    N = np.load(os.path.join(os.path.dirname(__file__), "trained_N.npy"))
    ...
    # ---- 1. 三 policy 评估 ----
    print(f"=== 评估：{N_EVAL} 个 seed × 3 个 policy ===")
    ...
    dist_path  = os.path.join(figs_dir, "eval_returns.png")
    slice_path = os.path.join(figs_dir, "policy_slice.png")
